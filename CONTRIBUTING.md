...
Thank you for your interest in contributing to the AL Development Collection! This document provides guidelines for contributing new instructions, prompts, or chat modes.
...
Instructions customize GitHub Copilot's behavior for specific AL development practices.
...
3. **Include frontmatter**:
   ...
   globs: ["*.al"]
   alwaysApply: true  # or false for contextual
   ---
   ```
...
Prompts are ready-to-use workflows for specific development tasks.

1. **Create your file** in `.github/copilot-prompts/`
...
Chat modes are specialized consultant personalities for strategic guidance.
